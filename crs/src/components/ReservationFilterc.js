...
function ReservationFilterc(props) {
    ...
    const search = () => {
        ...
        fetch(`/api/reservations/getReservations?rsrvID=${rsrvID}&userID=${props.userID}&plateID=${plate}&reserveTime=${reserveTime}&pickupTime=${pickupTime}&returnTime=${returnTime}`, {
            method: "GET",
        })
